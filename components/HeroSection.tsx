            ...
            <main className="relative z-10 flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto px-6 pt-12 lg:pt-20 pb-20 min-h-[calc(100vh-100px)]">
                ...
                >
                    ...
                    <p className="text-lg lg:text-xl text-gray-400 max-w-lg leading-relaxed">
                        Your personal AI wealth architect. Experience the clarity of data-driven financial guidance.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-4">
                        <Link href="/consultation" className="group relative px-8 py-4 bg-white text-aura-black rounded-full font-bold text-lg overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(0,240,255,0.4)]">
                            <span className="relative z-10 flex items-center gap-2">
                                Start AI advisor <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </span>
                ...
                >
                    ...
                    <div className="relative w-full h-full flex items-center justify-center">
                        ...
                        {/* Core Image */}
                        {/* Core Image Removed */}
                        <div className="relative z-10 w-[80%] h-[80%] flex items-center justify-center animate-float">
                            {/* Abstract CSS shape as replacement */}
                            <div className="w-64 h-64 bg-gradient-to-b from-aura-cyan/20 to-aura-purple/20 rounded-full blur-3xl"></div>
                        </div>
